...
public final class SetUpFacade {
    ...
    public void registerStartUpInfo(final boolean enabled) {
        ...
        serverService.persistOnline(enabled); //  /${jobname}/servers/172.16.67.21  设置ENABLED
        instanceService.persistOnline(); // 添加instances 比如: /${jobname}/instances/172.16.67.21@-@249736
