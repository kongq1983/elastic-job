...
public final class JobScheduler {
    ...
    public JobScheduler(final CoordinatorRegistryCenter regCenter, final ElasticJob elasticJob, final JobConfiguration jobConfig, final TracingConfiguration<?> tracingConfig,
        ...
        String jobClassName = JobClassNameProviderFactory.getProvider().getJobClassName(elasticJob); // 自己的job的className
        this.jobConfig = setUpFacade.setUpJobConfiguration(jobClassName, jobConfig); //处理JobConfiguration /${jobname}/config
