...
public final class LeaderNode {
    ...
    private static final String ELECTION_ROOT = ROOT + "/election"; // leader/election
    
    static final String INSTANCE = ELECTION_ROOT + "/instance";  // leader/election/instance
    
    static final String LATCH = ELECTION_ROOT + "/latch"; // leader/election/latch
