...
public final class ConfigurationService {
     ...
     * 
     * @param jobClassName job class name 自己实现的package+className
    ...
    public JobConfiguration setUpJobConfiguration(final String jobClassName, final JobConfiguration jobConfig) {
        ...
        if (!jobNodeStorage.isJobNodeExisted(ConfigurationNode.ROOT) || jobConfig.isOverwrite()) { //判断/${jobdemo}/config是否存在 或者是否覆盖属性=true
